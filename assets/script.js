...
$(function () {
  ...
  var atNine = localStorage.getItem('9PM');
  ...
  //Saves user input to storage
  $('#hour-9').children('button').on('click', function () {
    var ninePM = $('#hour-9').children('textarea').val();
    localStorage.setItem('9PM', ninePM);
  } )

  $('#hour-10').children('button').on('click', function () {
    var tenPM = $('#hour-10').children('textarea').val();
    localStorage.setItem('10PM', tenPM);
  } )
